    ...
    const handlerModal = (type) => {
        switch(type) {
            ...
            case "settings":
                ...
                setChildreModal(<SettingsForm setShowModal={setShowModal} setTitleModal={setTitleModal} setChildreModal={setChildreModal} />)
                setShowModal(true);
                break;
            default:
                break;
    ...
    return (
        ...
        <Grid className="profile">
            <Grid.Column width={5} className="profile__left">
                <Image src={getUser.avatar ? getUser.avatar : imageNotFound} 
                avatar 
            ...
            <Grid.Column width={11} className="profile__right">
                ...
                <div className="others">
                    <p className="name"><i>{getUser.name} {getUser.surname}</i></p>
                    {getUser.webSite && (
